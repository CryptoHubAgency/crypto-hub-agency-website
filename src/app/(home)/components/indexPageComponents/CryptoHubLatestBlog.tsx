...
const CryptoHubLatestBlog = () => {
  ...
  return (
    <section className="relative lg:overflow-hidden w-full h-full bg-white dark:bg-inherit dark:border-b dark:border-primary dark:border-opacity-25">
      <CryptoHubMaxWidth className="relative flex flex-col gap-8 lg:gap-8 pt-10 pb-[2rem] lg:pb-16 px-5 lg:px-[5rem] 2xl:px-[8.25rem] items-center justify-center">
        ...
        <div>
          <div className="flex justify-between">
            <h1 className="text-3xl text-dark dark:text-light font-bold mb-10">
              Read Our Blog
            </h1>
            <a
              href="#"
              className="text-lg font-semibold text-primary text-opacity-70 hover:scale-90"
            >
              VIEW ALL

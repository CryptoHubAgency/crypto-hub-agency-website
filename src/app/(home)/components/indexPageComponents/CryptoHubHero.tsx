...
const CryptoHubHero: FC<Props> = (props): JSX.Element => {
  return (
    <section className="relative lg:overflow-hidden w-full h-full">
      ...
      <CryptoHubMaxWidth className="relative flex flex-col lg:flex-row gap-8 lg:gap-8 lg:pt-20 pb-[2rem] lg:pb-16 px-5 lg:px-[5rem] 2xl:px-[8.25rem] justify-between">
